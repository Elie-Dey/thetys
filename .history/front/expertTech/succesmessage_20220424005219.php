    ...
    <?php  @include "../respoTech/respoTech-navbar.php"; 
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      if(!empty($_REQUEST['interventionMission'])){
         $typeMission  = $_REQUEST['interventionMission'];
      } else if(!empty($_REQUEST['assistanceMission'])){
        $typeMission = $_REQUEST['assistanceMission'];
      }
...
<div class="card cardMessage text-center mt-5 border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded">
    <div class="card-header">
      Message   <?= $var."   dur   ".$dureeReelle." date ".$dateDebutRelle." int ".$typeMission ?>
