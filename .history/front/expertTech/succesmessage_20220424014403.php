     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      if(!empty($_REQUEST['dateDebutReelle'])){
        $dateDebutRelle = $_REQUEST['dateDebutReelle'];
         ...
         $dateDebutRelle = $_REQUEST['dateDebut'];
      }
      ...
      if(!empty($_REQUEST['typeMission'])){
          $typeMission  = $_REQUEST['typeMission'];
      } else {
        $dateFinReelle = $_REQUEST['dateDeFin'];
      }
     
      $materiel1Reel = $_REQUEST['materiel1'];
      $materiel2Reel = $_REQUEST['materiel2'];
      $description = $_REQUEST['descriptions'];
      $typeMission  = $_REQUEST['typeMission'];
    
      
      if($typeMission != "Intervention"){
         $updateTypeMission = "UPDATE missioninterventions SET typeMission = 'Assistance' WHERE idmissionIntervention = $idMission";
