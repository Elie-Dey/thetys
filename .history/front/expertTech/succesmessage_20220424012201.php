    ...
    <?php  @include "../respoTech/respoTech-navbar.php"; 
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      if($typeMission != "Intervention"){
         $updateTypeMission= "UPDATE demandes SET statut = 'Devis effectué' WHERE demandes.iddemandes = $idDemande AND demandes.client_id = $idClient";
...
<div class="card cardMessage text-center mt-5 border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded">
    <div class="card-header">
      Message   <?= "   dur   ".$dureeReelle." date ".$dateDebutRelle." int ".$typeMission."alors ".$val ?>
