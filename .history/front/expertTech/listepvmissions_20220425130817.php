...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Lieu intervention </th>
       <th scope="col">Validation responsable Technique  </th>
      <th scope="col">Validation client </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $pvmission['signatureResponsable'] ?></td>
      <td>
      <?php if($pvmission['signatureClient']==NULL){
  ...
  <path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5.002 5.002 0 0 0 8 3zM3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9H3.1z"/>
        ...
        echo '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check2-all bg-success ms-5" viewBox="0 0 16 16">
  ...
  <path d="m5.354 7.146.896.897-.707.707-.897-.896a.5.5 0 1 1 .708-.708z"/>
      ...
      <td>
             <a href="../expertTech/detailpv.php" class="text-dark m-3">
