...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
          ...
          <label for="besoins">Besoins client</label> 
            ...
            ?>
            <div class="col-4">
              <label for="nomMembre" class="form-label"> Nom membre</label>
            ...
            <div class="col-4">
              <label for="nombreHeureMembrePrevu" class="form-label"> Nombre d'heure prévu</label>
              <input
              readonly
                type="text"
                class="form-control"
                name="nombreHeureMembrePrevu"
                value=" <?=  $membre['nbheures']?>"
              />
            </div>
            <div class="col-4">
              <label for="nombreHeureMembreReel" class="form-label"> Nombre d'heure reel</label>
              <input
                type="text"
                class="form-control"
                name="nombreHeureMembreReel"
                value=" <?=  $membre['nbheures']?>"
              />
            </div>
              <?php endforeach; 
  ...
  ?>
          ...
          <div class="col-md-6">
              <label for="typeMissionReel" class="form-label">Type de mission</label>
              <select name="typeMissionReel" class="form-select">
                <option  selectedvalue="1">Intervention</option>
            ...
            <div class="col-6">
             ...
             <div class="col-md-6">
              ...
              <select name="materiel1Reel" class="form-select">
            ...
            <div class="col-md-6">
              ...
              <select name="materiel2Reel" class="form-select">
