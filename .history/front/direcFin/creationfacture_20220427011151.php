...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
          ...
          <form class="row g-3 border border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded" method="POST" action="../direcFin/successfacture.php?idMission=<?=$demande['idmissionIntervention']?>">
           ...
           <textarea class="form-control fst-italic "  id="equipeMobilisee" style="height: 100px" readonly > <?php
                if($requeteMembreEquipe != FALSE ){
                  ...
                  foreach ($membres as $membre) {
                    ...
                    if($count == 1) {
                         echo "Responsable Equipe : ".$membre['nom']."    ".$membre['prenom']."    ( ".$membre['nbheures']."  h)"."   facturés  ".$membre['prixParHeure']." € /H    "."Heures sup : ". " $heureSup "."h". "\n"."\n";
                        $membre1 = $membre['nbheures'] * $membre['prixParHeure'];
                    } else{
                         echo " Ingénieur : ".$membre['nom']."    ".$membre['prenom']."    ( ".$membre['nbheures']."  h)"."   facturés  ".$membre['prixParHeure']." € /H    "."Heures sup : ". " $heureSup "."h"."\n";
                        $membre2 = $membre['nbheures'] * $membre['prixParHeure'];
                    }
                   
                  }

                $coutTotalMembre = $membre1 + $membre2;
                }
              ?>
              </textarea>
           ...
           <textarea class="form-control fst-italic "  id="matMobilisee" style="height: 100px" readonly > <?php
                if($requeteMaterielDemande != FALSE ){
                
                  $coutTotalMateriel = 0;
                  foreach ($materielsDemandes as $materielDemande) {
  
                  echo $materielDemande['nom']."  Coût location :   ".$materielDemande['coutLocation']. " €  Coût Expedition  : ". $materielDemande['coutExpedition'] ." € ". "\n". "\n"; 

                  $coutTotalMateriel = $materielDemande['coutLocation'] + $materielDemande['coutExpedition'];
                  }
              ...
              ?>
                ...
                <label for="matMobilisee">Matériels support</label>
            </div>
            ...
            <div class="col-4">
              ...
              readonly
                ...
                name="tva"
                value=" <?php
                echo ($coutTotalMateriel + $coutTotalMembre)*0.20  ;
            ...
            <div class="col-6">
              ...
              <input
                ...
                name="totalttc"
                value=" <?php
                echo ($coutTotalMateriel + $coutTotalMembre)*0.20 +($coutTotalMateriel + $coutTotalMembre)  ;
