...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
          ...
          <form class="row g-3 border border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded">
           ...
           <textarea class="form-control"  id="equipeMobilisee" style="height: 100px" readonly > <?php
                if($requeteMembreEquipe != FALSE ){
                  ...
                  foreach ($membres as $membre) {
                    ...
                    if($count == 1) {
                         echo "Responsable Equipe : ".$membre['nom']."    ".$membre['prenom']."    ( ".$membre['nbheures']."  h)"."   facturé  ".$membre['prixParHeure']." euros/H    "."Heures sup : ". "$heureSup "."\n"."\n";
                    // echo "Paul";
                    } else{
                         echo " Ingénieur : ".$membre['nom']."    ".$membre['prenom']."    ( ".$membre['nbheures']."  h)"."   facturé  ".$membre['prixParHeure']." euros/H    "."\n";
