           ...
           <textarea class="form-control fst-italic "  id="equipeMobilisee" style="height: 100px" readonly > <?php
                if($requeteMembreEquipe != FALSE ){
                  ...
                  foreach ($membres as $membre) {
                    ...
                    if($count == 1) {
                         echo "Responsable Equipe : ".$membre['nom']."    ".$membre['prenom']."    ( ".$membre['nbheures']."  h)"."   facturés  ".$membre['prixParHeure']." euros/H    "."Heures sup : ". " $heureSup "."h". "\n"."\n";
                    // echo "Paul";
                    } else{
                         echo " Ingénieur : ".$membre['nom']."    ".$membre['prenom']."    ( ".$membre['nbheures']."  h)"."   facturés  ".$membre['prixParHeure']." euros/H    "."Heures sup : ". " $heureSup "."h"."\n";
