          ...
          <form class="row g-3 border border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <div class="col-4">
              ...
              <input
                ...
                placeholder=" <?php  echo "La vie est belle";  ?>"
                value=""
              />
            </div>
            <div class="col-4">
            ...
            <div class="col-6">
              <input class="btn btn-danger m-3 d-grid gap-2 col-6 mx-auto" type="submit" name="genererFactutre" value="Annuler ma demande "> 
            </div>
          </form>
        </main>
      </div>
