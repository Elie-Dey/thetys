...
<div class="card cardMessage text-center mt-5 border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded">
  ...
  <div class="card-body p-5">
    ...
    <h5 class="card-text text-success">Etes-sur de vouloir supprimer l'élément? <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
