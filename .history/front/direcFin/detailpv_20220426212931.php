...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
 ...
 <div class="col-6">
              <button class="btn btn-danger m-3 d-grid gap-2 col-6 mx-auto" type="button">  
                  Validation client<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
