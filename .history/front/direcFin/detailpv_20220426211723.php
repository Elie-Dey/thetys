...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
  ...
  <label for="descriptions">Descriptions de l'equipe</label>
          ...
          <div class="col-6">
              <button type="button" class="btn btn-outline-warning waves-effect px-3"></i></button>
            </div>
            <div class="col-6">
             <button type="button" class="btn btn-outline-warning waves-effect px-3">Validation client</i></button>
            </div>
