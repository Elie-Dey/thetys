    ...
    <?php  @include "../direcFin/direcfin-navbar.php"; 
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      //Requete d'insertion des valeurs si c'est la premiere fois qu"elles sont saisies
       ...
       $sql = "INSERT INTO fichefacturations (idPVIntervention, signatureResponsable, signatureClient, dureeReelle, dateDebutRelle, dateFinReelle, materiel1Reel, materiel2Reel, description, commentaires, missionIntervention_id, statutPV) 
