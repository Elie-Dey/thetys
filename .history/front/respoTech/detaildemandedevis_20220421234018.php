...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
          ...
          <form class="row g-3 border border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <div class=" col-12 fst-italic text-decoration-underline fw-bolder">  Demande informations  <?= $rows ?> </div>
            <div class="col-md-6">
...
<div class="form-floating">
  ...
  <label for="conditionsParticulieres">Condition particulières</label>
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="interventionHumaine" value="
              <?php if ($rows == 1) {
                echo $requeteDevis['CoutIH'];
              } else {
                echo " ";
              }
               ?>" readonly />
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="coutMateriels"value="<?php 
               if ($rows == 1) {
                echo $requeteDevis['CoutMateriel'];
              } else {
                echo " ";
              }
               ?>" readonly />
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="tva"value="<?php
              if ($rows == 1) {
                echo $requeteDevis['tva'];
              } else {
                echo " ";
              }
               ?>
            ...
            <div class="col-md-12">
              ...
              <input type="text" class="form-control" id="totalttc"value="<?php
               if ($rows == 1) {
                echo $devis['CoutTotal'];
              } else {
                echo " ";
              }
               ?>" readonly />
