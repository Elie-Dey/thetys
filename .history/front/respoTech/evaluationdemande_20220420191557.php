...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
          ...
          <form class="row g-3 border border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded" action="../respoTech/successmessage.php?id=<?=$demande['iddemandes']?>.&idclient=<?=$demande['client_id']?>" method="POST">
...
<div class="form-floating">
  ...
  <label for="conditionsParticulieres">Condition particulières</label>
        ...
        <div class="col-md-4">
            ...
            <div class="col-6">
              <input  type="submit" class="btn btn-success m-3 d-grid gap-2 col-6 mx-auto" value="Envoyer">
            </div>
          </form>
        </main>
      </div>
