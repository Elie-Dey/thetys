...
<div class="form-floating">
  ...
  <label for="conditionsParticulieres">Condition particulières</label>
          ...
          <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="interventionHumaine" value="<?=$devis['CoutIH']?>" readonly />
            </div>
            <div class="col-md-4">
              <label for="coutMateriels" class="form-label">Coût Matériels </label>
              <input type="text" class="form-control" id="coutMateriels"value="<?=$devis['coutMateriel'] ?>" readonly />
            </div>
            <div class="col-md-4">
              <label for="tva" class="form-label">TVA</label>
              <input type="text" class="form-control" id="tva"value="<?=$devis['tva'] ?>" readonly />
            </div>
            <div class="col-md-12">
              <label for="totalttc" class="form-label">Total TTC</label>
              <input type="text" class="form-control" id="totalttc"value="<?=$devis['coutTotal'] ?>" readonly />
            </div>
