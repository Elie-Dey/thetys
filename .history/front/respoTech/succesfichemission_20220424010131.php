...
<div class="container-fluid">
    ...
    //   $idClient = $_GET['idclient'];
     ...
     //Requete d'insertion des valeurs si c'est la premiere fois qu"elles sont saisies
        ...
        $sql = "INSERT INTO missioninterventions (idmissionIntervention, localisationIntervention,dateDebut,dateFin, statutIntervention,typeMission equipe_id) 
                VALUES                             (NULL, '$lieuIntervention', '$dateDebut', '$dateFin', 'Fiche crée', 'Intervention', '$idEquipe')";
