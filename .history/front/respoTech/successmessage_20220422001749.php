...
<div class="container-fluid">
    ...
    <?php  @include "../respoTech/respoTech-navbar.php"; 
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      //Requete de mise à jour si les valeur sont modifiés 
      
        $update = "UPDATE demandes SET statut = 'Devis effectué' WHERE demandes.iddemandes = $idDemande AND demandes.client_id = $idClient";
...
<div class="card cardMessage text-center mt-5 border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded">
    <div class="card-header">
      Message   <?= $var." ".$coutInterventionHumaine ?> 
