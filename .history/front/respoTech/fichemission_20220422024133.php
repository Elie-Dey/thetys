...
<form class="row g-3 border border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded" action="../respoTech/succesfichemission.php" method="POST">
...
<div class="form-floating">
  ...
  <label for="conditionsParticulieres">Condition particulières</label>
              ...
              <select id="equipe" class="form-select">
                ...
                <?php 
                  foreach ($equipes as $equipe) {
                   echo "<option value=$equipe[idequipes]> $equipe[nomEquipe] - $equipe[statut]</option>"; 
                  }
            ...
            <div class="col-md-6">
               <?php 
                @require '../../back/admin.php';
                   $sql = "SELECT idequipes, nomEquipe
                           FROM equipes ";
              ...
              <select id="equipe" class="form-select">
                ...
                <?php 
                  foreach ($equipes as $equipe) {
                   echo "<option value=$equipe[idequipes]> $equipe[nomEquipe] - $equipe[nomEquipe] </option>"; 
                  }
