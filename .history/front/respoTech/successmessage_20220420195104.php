...
<div class="container-fluid">
    ...
    <?php  @include "../respoTech/respoTech-navbar.php"; 
     ...
     if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_REQUEST['interventionHumaine']) ){

      $coutInterventionHumaine = $_REQUEST['interventionHumaine'];
      $coutMateriels = $_REQUEST['coutMateriels'];
      $tva = $_REQUEST['tva'];
      ...
      $sql = "INSERT INTO `devis` (`iddevis`, `CoutIH`, `coutMateriel`, `coutTotal`, `client_id`, `statutDevis`, `demande_id`) 
              VALUES (NULL, '$coutInterventionHumaine', '$coutMateriels', '$totalTTc', '$idClient', 'Traité', '$idDemande')";
...
<div class="card cardMessage text-center mt-5 border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded">
  <div class="card-header">
    Message  <?php echo $tva."    ".$totalTTc."  id demande :".$val." id client :  ".$val2." ".$unval  ;?>
