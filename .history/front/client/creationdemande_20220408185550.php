...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
          ...
          <form class="row g-3 border border-2 rounded mb-3">
            <legend class="text-center"> Création nouvelle demande</legend>
            <div class="col-md-6">
...
<div class="form-floating">
  ...
  <label for="conditionsParticulieres">Condition particulières</label>
            ...
            <div class="col-12">
              <button type="submit" class="btn btn-primary m-3 d-grid gap-2 col-6 mx-auto">Faire ma demande</button>
            </div>
          </form>
        </main>
      </div>
