...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
          ...
          <form class="row g-3 border border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <div class=" col-12 fst-italic text-decoration-underline fw-bolder"> Résumé demande </div>
            <div class="col-md-6">
...
<div class="form-floating">
  ...
  <label for="conditionsParticulieres">Condition particulières</label>
          ...
          <div class=" col-12 fw-bold text-decoration-underline">  Coûts </div>
        <div class="col-md-4">
            ...
            <div class="col-md-4">
             ...
             <div class="col-6">
              <input class="btn btn-danger m-3 d-grid gap-2 col-6 mx-auto" name="annulerDevis" type="submit" value="Annuler la validation">
            </div>
            <div class="col-6">
