  ...
  <label for="conditionsParticulieres">Condition particulières</label>
        ...
        <div class="col-md-4">
            ...
            <div class="col-md-4">
             ...
             <div class="col-6">
              <input class="btn btn-danger m-3 d-grid gap-2 col-6 mx-auto" name="annulerDemande" type="submit" value="Annuler la validation">
            </div>
            <div class="col-6">
              <input class="btn btn-success m-3 d-grid gap-2 col-6 mx-auto" type="submit" value="Valider le devis">
            </div>
          </form>
        </main>
      </div>
