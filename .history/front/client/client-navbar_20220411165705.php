...
<style>
 li {
        ...
        >
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              <li class="nav-item">
                <a
                  class=" <?php active('accueil/accueil.php');?> nav-link fs-5"
                  aria-current="page"
  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
              ...
              <li class="nav-item">
                <a class="nav-link <?php active('client/creationdemande.php');?>  fs-5" href="../client/creationdemande.php">
                  <span>
