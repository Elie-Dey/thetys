...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
   ...
   <thead>
    <tr>
      ...
      <th scope="col">Validation du Responsable</th>
  ...
  <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/>
         ...
         <a href="../client/signaturepv.php?id=<?=$pvmission['idPVIntervention']?>&idDemande=<?=$pvmission['iddemandes']?>" class="text-dark m-3">
