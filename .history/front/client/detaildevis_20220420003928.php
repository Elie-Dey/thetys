...
<div class="form-floating">
  ...
  <label for="conditionsParticulieres">Condition particulières</label>
        ...
        <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="interventionHumaine" value="<?= $devis['InterventionHumaine']?>" readonly />
            </div>
            <div class="col-md-4">
              <label for="coutMateriels" class="form-label">Coût Matériels </label>
              <input type="text" class="form-control" id="coutMateriels"value="" readonly />
            </div>
            <div class="col-md-4">
              <label for="tva" class="form-label">TVA</label>
              <input type="text" class="form-control" id="tva"value="" readonly />
            </div>
            <div class="col-md-12">
              <label for="totalttc" class="form-label">Total TTC</label>
              <input type="text" class="form-control" id="totalttc"value="" readonly />
            </div>
            ...
            <div class="col-6">
              <a href="../client/successmessage.php" class="btn btn-success m-3 d-grid gap-2 col-6 mx-auto"> Valider </a>
            </div>
          </form>
        </main>
      </div>
