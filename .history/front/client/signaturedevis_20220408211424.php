...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5">
          ...
          <form class="row g-3 border border-2 rounded mb-3 shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" role="switch" id="assistanceMission">
                <label class="form-check-label" for="assistanceMission">Default switch checkbox input</label>
            </div>
            <div class="form-check form-switch">
                 <input class="form-check-input" type="checkbox" role="switch" id="interventionMission" checked>
                 <label class="form-check-label" for="interventionMission">Checked switch checkbox input</label>
            </div>


          <div class="col-6">
              <input class="btn btn-danger m-3 d-grid gap-2 col-6 mx-auto" type="submit" name="annulerValidation" value="Annuler ma demande "> 
            </div>
            <div class="col-6">
              <input class="btn btn-primary m-3 d-grid gap-2 col-6 mx-auto" type="submit" name="validationPV" value="Envoyer ma demande "> 
            </div>
          </form>
        </main>
      </div>
