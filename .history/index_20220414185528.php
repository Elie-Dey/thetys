...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <main class="form-signin">
      <form class="border border-2 rounded shadow-lg p-2 bg-body rounded <p class="mt-5 pt-5 mb-3 text-white">Powered By SMART CONSULTING</p>" action="../thetys/back/connexion/login.php" method="POST">
