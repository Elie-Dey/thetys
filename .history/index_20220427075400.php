  ...
  <body class="text-center">
    ...
    <main class="form-signin">
      <form class="border border-2 rounded shadow-lg p-2 bg-body rounded bg-opacity-50" action="../thetys/back/connexion/login.php" method="POST">
        <h1 class="h3 mb-5 fw-bold text-white">AIRBLIO - TETHYS</h1>
      ...
      <p class="mt-5 pt-5 mb-3 text-white">Powered By SMART CONSULTING  <img src="images/logo.jpg"  width="70" height="70" alt="" srcset="">  </p>
    </main>
  </body>
</html>
